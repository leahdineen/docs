...
```json
{
  ...
  "metrics": {
    ...
    "model": "gpt-4o-mini",
    "requirements": {
      "min_desired_matches": 1,
      "max_undesired_matches": 0
    }
  },
  "timestamps": [],
  "flagged_frames": [],
...
- **desired_count/undesired_count/prohibited_count**: Totals used to determine pass/fail.
- **desired_matches/undesired_matches**: Evidence snippets for sentiment checks.
- **requirements**: Thresholds applied for sentiment counts.
