...
```json Success Response (202)
{
  ...
  "progress_tracking": {
    "progress_url": "https://api.judge.example.com/retraining/runs/retrain_run_123/progress",
...
```json Threshold Response (202)
{
  ...
  "progress_tracking": {
    "progress_url": "https://api.judge.example.com/retraining/runs/retrain_run_456/progress",
